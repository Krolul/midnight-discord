...
1. download the theme file, [`midnight.theme.css`](https://github.com/Krolul/midnight-discord/blob/master/themes/midnight.theme.css). (there should be a download button at the top right of the page)
